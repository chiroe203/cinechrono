...
{/* 日本史の時代区分 */}
            <div className="mb-12 mt-8">
              <h2 className="text-2xl font-bold mb-6 text-center">🇯🇵 日本史の時代区分（参考）</h2>
              <p className="text-center text-gray-600 mb-8">世界史の時代区分と日本史を対比することで、同時代の出来事を理解しやすくなります。</p>
              ...
              <div className="overflow-x-auto">
                <div className="min-w-[600px]">
                  ...
                  {/* 日本史の時代区分バー */}
                  <div className="flex h-10 rounded-lg overflow-hidden shadow-lg mb-2">
                    <div className="w-[10%] bg-gradient-to-r from-stone-400 to-stone-500 flex items-center justify-center text-white text-xs font-bold">
                      <span>縄文</span>
                    </div>
                    <div className="w-[8%] bg-gradient-to-r from-amber-400 to-amber-500 flex items-center justify-center text-white text-xs font-bold">
                      <span>弥生</span>
                    </div>
                    <div className="w-[6%] bg-gradient-to-r from-amber-600 to-amber-700 flex items-center justify-center text-white text-xs font-bold">
                      <span>古墳</span>
                    </div>
                    <div className="w-[4%] bg-gradient-to-r from-rose-400 to-rose-500 flex items-center justify-center text-white text-xs font-bold">
                      <span>飛鳥</span>
                    </div>
                    <div className="w-[4%] bg-gradient-to-r from-rose-500 to-rose-600 flex items-center justify-center text-white text-xs font-bold">
                      <span>奈良</span>
                    </div>
                    <div className="w-[10%] bg-gradient-to-r from-pink-500 to-pink-600 flex items-center justify-center text-white text-xs font-bold">
                      <span>平安</span>
                    </div>
                    <div className="w-[6%] bg-gradient-to-r from-emerald-500 to-emerald-600 flex items-center justify-center text-white text-xs font-bold">
                      <span>鎌倉</span>
                    </div>
                    <div className="w-[8%] bg-gradient-to-r from-emerald-600 to-emerald-700 flex items-center justify-center text-white text-xs font-bold">
                      <span>室町</span>
                    </div>
                    <div className="w-[3%] bg-gradient-to-r from-cyan-500 to-cyan-600 flex items-center justify-center text-white text-xs font-bold">
                      <span className="text-[10px]">桃山</span>
                    </div>
                    <div className="w-[15%] bg-gradient-to-r from-cyan-600 to-cyan-700 flex items-center justify-center text-white text-xs font-bold">
                      <span>江戸</span>
                    </div>
                    <div className="w-[4%] bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center text-white text-xs font-bold">
                      <span>明治</span>
                    </div>
                    <div className="w-[2%] bg-gradient-to-r from-blue-600 to-blue-700 flex items-center justify-center text-white text-xs font-bold">
                      <span className="text-[10px]">大</span>
                    </div>
                    <div className="w-[6%] bg-gradient-to-r from-indigo-500 to-indigo-600 flex items-center justify-center text-white text-xs font-bold">
                      <span>昭和</span>
                    </div>
                    <div className="w-[3%] bg-gradient-to-r from-purple-500 to-purple-600 flex items-center justify-center text-white text-xs font-bold">
                      <span className="text-[10px]">平成</span>
                    </div>
                    <div className="w-[1%] bg-gradient-to-r from-purple-600 to-purple-700 flex items-center justify-center text-white text-xs font-bold">
                    </div>
                  </div>
